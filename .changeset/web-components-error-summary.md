...
the form was mounted under. `<texaryn-form error-summary>` and the
`errorSummary` property mount it as the first child of the element's form. It
is not a live region: the fields already announce their own errors.
